...
### Swisstronik-Testnet-Technical Task 4 ( Mint a PERC-20 token ) Guide
...
- create a " name.sh File " ( copy Code and Paste inside name.sh File ) : Code : https://github.com/aMaheshr/nodes/blob/main/swissperc20.sh
...
Fill Form on Swisstronic Mint a PERC-20 token
